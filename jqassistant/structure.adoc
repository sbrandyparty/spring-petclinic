[[structure:Default]]
[role=group,includesConstraints="structure:ControllerDependencies,structure:ServiceDependencies,structure:RepositoryDependencies,structure:ImplementationDependencies,dependency:PackageCycles",includesConcepts="structure:ComponentDependencies.graphml"]
...
[[structure:ComponentDependencies.graphml]]
[source,cypher,role=concept,requiresConcepts="structure:ComponentDependencies",reportType="graphml"]
